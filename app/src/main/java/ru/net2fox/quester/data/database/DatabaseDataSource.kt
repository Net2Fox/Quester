...
import ru.net2fox.quester.data.model.*


/**
 * Класс, обрабатывающий получение данных пользователя из базы данных
 */
class DatabaseDataSource private constructor(context: Context) {
    ...
    companion object {
        ...
        fun get(): DatabaseDataSource {
            return INSTANCE ?:
            throw IllegalStateException("DatabaseDataSource must be initialized")
        }
    }
}